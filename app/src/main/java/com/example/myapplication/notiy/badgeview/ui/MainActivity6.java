package com.example.myapplication.notiy.badgeview.ui;
...
import com.example.myapplication.notiy.badgeview.Badge;
import com.example.myapplication.notiy.badgeview.QBadgeView;
    ...
    private void selectorColor(final OnColorClickListener l) {
        ...
        gv.setAdapter(new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                View v = new View(MainActivity6.this);
                ...
                WindowManager wm = (WindowManager) MainActivity6.this

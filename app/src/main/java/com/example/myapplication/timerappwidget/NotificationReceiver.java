package com.example.myapplication.timerappwidget;
...
import static com.example.myapplication.timerappwidget.TimerAppWidget.CHANGE_STATE;
import static com.example.myapplication.timerappwidget.TimerAppWidget.IMAGE_COUNT;
import static com.example.myapplication.timerappwidget.TimerAppWidget.mAvatars;
import static com.example.myapplication.timerappwidget.TimerAppWidget.mNames;
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public static NotificationCompat.Builder getNotification(Context context) {
        ...
        // 点击头像跳转主页
        Intent mainIntent = new Intent(context, MainActivity3.class);

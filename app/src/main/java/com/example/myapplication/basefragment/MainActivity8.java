            ...
            case R.id.fragment_main:
                ...
                fragment.setFunctions(new Functions().addFunction(new Functions.FunctionNoParamAndResult(MainFragment.FUNCTION_NO_PARAM_NO_RESULT) {
                    ...
                    public void function() {
                        Toast.makeText(MainActivity8.this, "成功调用无参无返回值方法", Toast.LENGTH_LONG).show();
                    }
                }).addFunction(new Functions.FunctionWithResult<String>(MainFragment.FUNCTION_NO_PARAM_HAS_RESULT) {
                    @Override
                    public String function() {
                        Toast.makeText(MainActivity8.this, "成功调用无参有返回值方法", Toast.LENGTH_LONG).show();
                        return "恭喜你，调我成功！";
                    }
                    ...
                    public void function(Integer o) {
                        Toast.makeText(MainActivity8.this, "成功调用有参无返回值方法 参数值=" + o, Toast.LENGTH_LONG).show();
                    }
                    ...
                    public List function(Integer data) {
                        Toast.makeText(MainActivity8.this, "成功调用有参有返回值方法 参数值=" + data, Toast.LENGTH_LONG).show();
                    ...
                    public void function(Functions.FunctionParams functionParams) {
                        if (functionParams != null) {
                            ...
                            Toast.makeText(MainActivity8.this, "成功调用多个参数的方法 参数值=" + functionParams.getString()+" 参数1="+functionParams.getString()+" 参数2="+functionParams.getInt(), Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    public void function(Bundle bundle) {
                        if(bundle != null){
                            Toast.makeText(MainActivity8.this, "成功调用多个参数的方法 参数值=" + bundle.getString("p")+" 参数1="+bundle.getString("p1")+" 参数2="+bundle.getInt("p2"), Toast.LENGTH_LONG).show();
